    ...
    switch (state.flashMode) {
        ...
        case FlashMode::TIMED:
            if (mWhiteLED) {
                ...
                rc = kLEDs[RED].setBreath(state, color.red && color.red);
                rc &= kLEDs[GREEN].setBreath(state, color.green && color.green);
                rc &= kLEDs[BLUE].setBreath(state, color.blue && color.blue);
            }
            if (rc) break;
