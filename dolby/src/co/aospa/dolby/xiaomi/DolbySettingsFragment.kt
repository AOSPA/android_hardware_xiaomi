...
class DolbySettingsFragment : PreferenceFragment(),
    ...
    override fun onPreferenceChange(preference: Preference, newValue: Any): Boolean {
        dlog("onPreferenceChange: key=${preference.key} value=${newValue.toString()}")
        when (preference.key) {
    ...
    override fun onSwitchChanged(switchView: Switch, isChecked: Boolean) {
        dlog("onSwitchChanged($isChecked)")
    ...
    private fun updateProfileSpecificPrefs() {
        ...
        dlog("updateProfileSpecificPrefs: dsOn=$dsOn currentProfile=$currentProfile"
